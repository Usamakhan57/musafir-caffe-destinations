...
export default function GuidesHero() {
  return (
    <header className="relative overflow-hidden bg-white pt-0">
      ...
      <div className="relative z-10 mx-auto flex h-[720px] max-w-[1400px] items-center px-6 lg:px-12">
        <div className="grid w-full gap-12 lg:grid-cols-[55%_45%]">
          <FadeIn>
            <div className="flex max-w-[620px] flex-col justify-center gap-6">
              <span className="text-[10px] uppercase tracking-[0.35em] text-[#2563EB]">Guides · Travel · Coffee</span>
              <h1 className="font-serif text-[3.6rem] leading-[0.95] font-semibold text-white md:text-[4.5rem]">
                Discover coffee-rich journeys, local cafés, and travel stories built for explorers.
              </h1>
              <p className="max-w-[520px] text-lg leading-8 text-white/85">
